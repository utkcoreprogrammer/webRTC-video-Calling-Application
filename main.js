...
var startButton = document.getElementById('startButton').checked=true;
var callButton = document.getElementById('callButton');
var hangupButton = document.getElementById('hangupButton');
var AudioButton = document.getElementById('AudioButton').checked=false;
...
navigator.mediaDevices.getUserMedia(constraints).
    then(startAudio).catch(handleError);
